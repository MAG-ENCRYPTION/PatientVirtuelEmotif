            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 items-center gap-x-16 gap-y-10">
                    ...
                    <div className="order-last lg:order-first">
                        ...
                        <div className="w-full h-96 bg-gray-200 rounded-2xl flex items-center justify-center">
                            <span className="text-gray-500">
                                <img
                                    src="/images/aboutus/PatientDiscussion.png"
                                    alt="DiagVerse Logo"
                    ...
                    <div className="text-lg text-gray-700 leading-relaxed">
                        ...
                        <p className="mt-4">
                            DiagVerse offre un environnement 3D immersif pour s'entraîner,
                            expérimenter face à des patients virtuels, et perfectionner les compétences
